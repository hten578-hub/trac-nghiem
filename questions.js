// ================================================================
//  FILE CÂU HỎI — chỉnh sửa tại đây, không cần đụng server.js
//
//  Cấu trúc mỗi câu:
//  {
//    id: <số thứ tự>,
...
//    explain: "Giải thích (chỉ hiện khi chọn ĐÚNG)"  // tùy chọn
//  }
// ================================================================
...
const questions = [
  ...
  },
  {
    ...
    answer: 0,
    explain: "Ngày 1 xuất: $180 \\times \\frac{1}{3} = 60\\text{ kg}$. Ngày 2 xuất: $60 + 15 = 75\\text{ kg}$. Còn lại: $180 - 60 - 75 = 45\\text{ kg}$."
  },
  {
    id: 6,
